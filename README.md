...
2.  Отчет по лабораторной работе доступен по ссылке: [Отчет](https://github.com/divoskov/inet_labs/blob/main/lab3.png)
Лабораторная работа выполнялась в среде GNS3.
